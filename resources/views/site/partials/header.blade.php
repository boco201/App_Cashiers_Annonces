                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="widgets-wrap d-flex justify-content-end">
                        ...
                        @guest
                            ...
                            <div class="widget-header">
                                <a href="{{ route('site.utilisateurs.signup') }}" class="ml-3 icontext">
                                    <div class="icon-wrap icon-xs bg-success round text-white"><i class="fa fa-user"></i></div>
                                    <div class="text-wrap"><span>Compte</span></div>
                                </a>
                            </div>
                            <div class="widget-header">
                                <a href="{{ route('site.subscribes.subscribe') }}" class="ml-3 icontext">
                                    <div class="icon-wrap icon-xs bg-success round text-white"><i class="fa fa-user"></i></div>
                                    <div class="text-wrap"><span>ComptePro</span></div>
                                </a>
                            </div>
                        @else
